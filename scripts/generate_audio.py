...
def generate_chime_samples():
    """Exact replica of ChimePlayer.kt synthesis (D5 587.33 Hz + A5 880.00 Hz)."""
    duration1 = 0.09
    duration2 = 0.16
