...
def main():
    ...
    out_wav = 'demo/sotto_soundtrack_id.wav'
    ...
    in_video = 'demo/sotto_demo_id_video.mp4'
    out_video = 'demo/sotto_demo_id.mp4'
    cmd = [
        ffmpeg_bin, '-y',
        '-i', in_video,
        '-i', out_wav,
    ...
    print(f"Muxed Indonesian video saved to {out_video}")
